use {
  ...
  groestlcoincore_rpc::groestlcoincore_rpc_json::{ImportDescriptors, SignRawTransactionInput, Timestamp},
...
pub(crate) struct Inscribe {
  ...
  #[arg(long, help = "Use fee rate of <FEE_RATE> gros/vB.")]
  ...
  #[arg(help = "Inscribe gro with contents of <FILE>.")]
  ...
  #[arg(
    long,
    help = "Amount of postage to include in the inscription. Default `10000gro`."
  )]
...
impl Inscribe {
  ...
  fn create_inscription_transactions(
    ...
    if !no_limit && reveal_weight > groestlcoin::Weight::from_wu(MAX_STANDARD_TX_WEIGHT.into()) {
      bail!(

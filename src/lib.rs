...
const DIFFCHANGE_INTERVAL: u32 = groestlcoin::blockdata::constants::DIFFCHANGE_INTERVAL;
const SUBSIDY_HALVING_INTERVAL: u32 = groestlcoin::blockdata::constants::SUBSIDY_HALVING_INTERVAL;

  ...
  T: PageContent,
{
  ...
  fn og_image(&self) -> String {
    if let Some(domain) = &self.config.domain {
      ...
      "https://ordinals.groestlcoin.org/static/favicon.png".into()
    }
  }
  ...
  fn page() {
    assert_regex_match!(
      Foo.page(Arc::new(ServerConfig {
        chain: Chain::Mainnet,
        csp_origin: Some("https://ordinals-signet.groestlcoin.org".into()),
        domain: Some("ordinals-signet.groestlcoin.org".into()),
        index_sats: true,
        ..Default::default()
      }),),
      r"<!doctype html>
<html lang=en>
  <head>
    ...
    <meta property=og:image content='https://ordinals-signet.groestlcoin.org/static/favicon.png'>

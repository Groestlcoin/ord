...
fn inscribe_to_address_on_different_network() {
  ...
  CommandBuilder::new(
    "wallet inscribe --destination tgrs1qsgx55dp6gn53tsmyjjv4c2ye403hgxynx4tkzr --file degenerate.png --fee-rate 1"
  )
  .write("degenerate.png", [1; 520])
  .rpc_server(&rpc_server)
  .expected_exit_code(1)
  .stderr_regex("error: address tgrs1qsgx55dp6gn53tsmyjjv4c2ye403hgxynx4tkzr belongs to network testnet which is different from required groestlcoin\n")
  .run_and_extract_stdout();
}
